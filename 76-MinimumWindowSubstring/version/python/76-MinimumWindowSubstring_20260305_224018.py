# Last updated: 3/5/2026, 10:40:18 PM
1class Solution:
...
34                        window_counts[s[left]] -= 1
35                        if window_counts[s[left]] == t_counts[s[left]] - 1:
36                            have -= 1
37                    left += 1
38
39        return '' if reslen == float('inf') else s[res[0]: res[1] + 1]